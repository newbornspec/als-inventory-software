      ...
      {selectedList.length > 0 && canManage && (
        <div className="mt-4 flex flex-wrap items-center gap-3 rounded-lg border border-[#1a6ef5] bg-blue-50 px-4 py-3">
          <span className="text-sm font-medium text-neutral-950">
            ...
            {tooManyToExport && (
              <span className="ml-2 font-normal text-red-800">
                Too many to export at once — narrow the selection to{' '}
                {MAX_EXPORT_PALLETS} or fewer.
              </span>
            )}
          </span>
        ...
        <table className="w-full border-collapse text-left text-sm lg:min-w-[64rem]">
          ...
          <thead className="bg-neutral-50">
            <tr>
              ...
              {/* Restored: the previous page showed supplier as a column, and
                  moving it into the phone-only detail row made it unreadable on
                  every desktop — you could filter BY a supplier but never see
