      ...
      <div className="p-8">
        ...
        <div className="mt-6 grid gap-8 md:grid-cols-2">
          <section>
            ...
            {canManage && (
              <div className="mt-4">
                <h2 className="mb-2 text-sm font-medium text-neutral-500">Adjust stock</h2>
          ...
          <section>
            <h2 className="text-sm font-medium text-neutral-500">Movements ({movements.length})</h2>
              ...
              {movements.map((m) => (
                ...
                >
                  <div>
                    <span
                      className={
                        'font-medium ' + (m.delta > 0 ? 'text-emerald-700' : 'text-red-600')
                      }
                    >
                      {m.delta > 0 ? '+' : ''}
                      {m.delta}
                    </span>
                    <span className="ml-2 text-neutral-500">{formatLabel(m.reason)}</span>
