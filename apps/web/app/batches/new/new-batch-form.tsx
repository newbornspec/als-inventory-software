  ...
  return (
    <form action={formAction} className="mt-6 max-w-sm space-y-3">
      <div className="space-y-1">
        <label className="text-sm text-neutral-700">Supplier</label>
        <input
          name="source"
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="space-y-1">
          <label className="text-sm text-neutral-700">Purchase order</label>
          <input
            name="purchaseOrder"
        ...
        <div className="space-y-1">
          <label className="text-sm text-neutral-700">Delivery note</label>
          <input
            name="deliveryNote"
            placeholder="DN-4471"
            className="w-full rounded-md border border-neutral-200 bg-white px-3 py-2 text-sm outline-none focus:border-neutral-300"
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="space-y-1">
          <label className="text-sm text-neutral-700">Purchase date</label>
          <input
            type="date"
            name="purchaseDate"
            className="w-full rounded-md border border-neutral-200 bg-white px-3 py-2 text-sm outline-none focus:border-neutral-300"
        ...
        <div className="space-y-1">
          <label className="text-sm text-neutral-700">Expected unit count</label>
          <input
            type="number"
            min={0}
