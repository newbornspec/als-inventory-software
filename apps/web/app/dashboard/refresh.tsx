  ...
  return (
    <div className="flex flex-wrap items-center gap-3 rounded-xl border border-neutral-200 bg-white px-4 py-3">
      <p className="text-xs text-neutral-600">
        ...
        <span aria-live="polite" className="mt-0.5 block text-sm text-neutral-900 tabular-nums">
          {shown ?? '—'}
        </span>
      </p>
      <button
        ...
        disabled={pending}
        className="inline-flex items-center gap-2 rounded-md border border-neutral-300 bg-white px-3 py-2 text-xs font-semibold uppercase tracking-wide text-neutral-800 transition-colors hover:bg-neutral-50 disabled:opacity-60"
      >
