  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      ...
      <button
        ...
        disabled={pending}
        className="inline-flex items-center gap-2 rounded-lg border border-[var(--control-border)] px-3 py-1.5 text-sm font-medium text-neutral-800 transition-colors hover:bg-neutral-50 disabled:opacity-60"
      >
